...
def parse_args():
    ...
    # choose model
    parser.add_argument('--model', type=str, default='EAMNet',
                        help='model name:  EAMNet')
    ...
    parser.add_argument('--dataset', type=str, default='NUAA_SIRST',
                        help='dataset name: NUAA_SIRST')
