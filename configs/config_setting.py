...
class setting_config:
    ...
    datasets = 'NUAA-sirst'
    if datasets == 'NUAA-sirst':
        data_path = './sirst_data/sirst'
    elif datasets == 'IRSTD-1k':
        data_path = ''
    else:
    ...
    work_dir = 'results/' + network + '_' + datasets + '_'+ network + '_'+ datetime.now().strftime('%A_%d_%B_%Y_%Hh_%Mm_%Ss') + '/'
